...
<div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell--12-col">
  <input class="mdl-textfield__input" type="text" id="field_theme_image" value="{{ $blog_post->theme_image }}" name="title">
...
<div class="mdl-textfield mdl-js-textfield mdl-cell mdl-cell--12-col">
  <textarea class="mdl-textfield__input" type="text" rows="3" id="field_content" name="content">{{ $blog_post->content }}</textarea>
  <label class="mdl-textfield__label" for="field_content">Content</label>
</div>
<div class="mdl-cell mdl-cell--12-col">
  <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="switch-1">
    @if($blog_post->online == 'online')
      <input type="checkbox" id="switch-1" class="mdl-switch__input" name="online" checked>
    @else
      <input type="checkbox" id="switch-1" class="mdl-switch__input" name="online">
    @endif
